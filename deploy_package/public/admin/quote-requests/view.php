...
try {
    ...
    error_log("PDO Error fetching quote request ID {$requestId}: " . $e->getMessage());
    error_log("SQL State: " . $e->getCode());
    error_log("Error Info: " . print_r($e->errorInfo, true));
    setErrors(['general' => 'Database error: Unable to load quote request. Please check the error logs.']);
    redirect(url('admin/quote-requests.php'));
} catch (Exception $e) {
    error_log("Error fetching quote request ID {$requestId}: " . $e->getMessage());
